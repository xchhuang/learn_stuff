...
Thread.thread().file_resolver().append('../data/scenes/cbox')
scene = load_file('../data/scenes/cbox/cbox-spectral.xml')
...
write_bitmap(output_folder+'/out_ref.png', image_ref, crop_size)
...
for it in range(iterations):
    ...
    write_bitmap(output_folder+'/out_%03i.png' % it, image, crop_size)
...
write_bitmap(output_folder+'/out_final.png', image, crop_size)
